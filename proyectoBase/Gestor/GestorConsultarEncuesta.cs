...
namespace proyectoBase.Gestor
{
	public class GestorConsultarEncuesta
	{
		...
		public GestorConsultarEncuesta()
		{
			...
			//cambios de estados para la llamada3
			...
			RespuestaCliente respuestaDeEncuesta11 = new RespuestaCliente(DateTime.Parse("2015-02-13"),);
			RespuestaCliente respuestaDeEncuesta12 = new RespuestaCliente(DateTime.Parse("2015-02-13"),);
			RespuestaCliente respuestaDeEncuesta13 = new RespuestaCliente(DateTime.Parse("2015-02-13"),);
			...
			RespuestaCliente respuestaDeEncuesta21 = new RespuestaCliente(DateTime.Parse("2015-02-13"),);
			RespuestaCliente respuestaDeEncuesta22 = new RespuestaCliente(DateTime.Parse("2015-02-13"),);
			
			List<RespuestaCliente> respuestaDeEncuesta2 = new List<RespuestaCliente>();
			respuestaDeEncuesta2.Add(respuestaCliente21);
			respuestaDeEncuesta2.Add(respuestaCliente22);
			...
			respuestaDeEncuesta1.Add(respuestaCliente31);
			respuestaDeEncuesta1.Add(respuestaCliente32);
			...
			respuestaDeEncuesta1.Add(respuestaCliente41);
			respuestaDeEncuesta1.Add(respuestaCliente42);
			...
			respuestaDeEncuesta1.Add(respuestaCliente5);
			...
			respuestaDeEncuesta1.Add(respuestaCliente61);
			respuestaDeEncuesta1.Add(respuestaCliente62);
			respuestaDeEncuesta1.Add(respuestaCliente63);
			...
			respuestaDeEncuesta1.Add(respuestaCliente71);
			respuestaDeEncuesta1.Add(respuestaCliente72);
			respuestaDeEncuesta1.Add(respuestaCliente73);
			...
			respuestaDeEncuesta1.Add(respuestaCliente91);
			respuestaDeEncuesta1.Add(respuestaCliente92);
			respuestaDeEncuesta1.Add(respuestaCliente93);
			
			// Rdc para la llamada nro 10
			RespuestaCliente respuestaDeEncuesta101 = new RespuestaCliente(DateTime.Parse("2015-02-13"),);
			RespuestaCliente respuestaDeEncuesta102 = new RespuestaCliente(DateTime.Parse("2015-02-13"),);
			List<RespuestaCliente> respuestaDeEncuesta10 = new List<RespuestaCliente>();
			respuestaDeEncuesta1.Add(respuestaDeEncuesta101);
			respuestaDeEncuesta1.Add(respuestaDeEncuesta102);

			// LLAMADAS -10 MINIMO-. DIFERENTES ENTRE SI PARA VER SI EL CDU FILTRA CORRECTAMENTE
			LLamada llamada1 = new Llamada("descLlamada1", "detalleEncuestaLLamada1",1,true,cliente1,respuestaDeEncuesta1, cambioEstado1);
			LLamada llamada2 = new Llamada("descLlamada1", "detalleEncuestaLLamada1",1,true,cliente1,respuestaDeEncuesta1, cambioEstado2);
			LLamada llamada3 = new Llamada("descLlamada1", "detalleEncuestaLLamada1",1,true,cliente1,respuestaDeEncuesta1, cambioEstado3);
